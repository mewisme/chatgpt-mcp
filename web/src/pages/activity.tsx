...
export type ActivityEvent = { sequence?: number; kind: string; method?: string; source?: string; tool?: string; workspace_id?: string; status?: string; duration_ms?: number; message?: string; timestamp: string }
