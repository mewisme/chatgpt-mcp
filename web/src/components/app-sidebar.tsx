...
const items = [{ id: "overview", title: "Overview", icon: Home }, { id: "tools", title: "Tools", icon: Wrench }, { id: "servers", title: "MCP Servers", icon: Server }, { id: "settings", title: "Settings", icon: Settings }]
