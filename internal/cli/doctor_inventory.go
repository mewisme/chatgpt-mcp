...
var doctorToolsCoverage = map[string]doctorCoverage{
	...
	"PluginStore":      {Checks: []string{"plugin.lock", "plugin.desired", "plugin.capabilities", "plugin.registry", "plugin.payloads", "plugin.compatibility", "plugin.host", "plugin.admin-ui", "plugin.secure-mcp-tunnel", "plugin.tui", "plugin.markdown-formatter", "plugin.ponytail", "plugin.caveman"}},
