...
try {
  ...
  run(["config", "set", "interactive", "false"])
  const nonInteractiveConfig = run(["config", "get", "interactive"], { quiet: true })
  if (!nonInteractiveConfig.includes("false")) fail(`interactive=false was not persisted:\n${nonInteractiveConfig}`)
  run(["config", "set", "interactive", "true"])
  const interactiveConfig = run(["config", "get", "interactive"], { quiet: true })
  if (!interactiveConfig.includes("true")) fail(`interactive=true was not persisted:\n${interactiveConfig}`)
  run(["config", "verify"])
