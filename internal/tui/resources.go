...
func pageQuickOpenResources() []quickopen.Resource {
	return []quickopen.Resource{
		...
		{ID: "plugins", Title: "Plugins", Kind: "Page", Keywords: []string{"plugin", "installed"}, Path: []string{"plugins"}},
		{ID: "plugins-marketplace", Title: "Plugin Marketplace", Kind: "Page", Keywords: []string{"plugin", "marketplace", "search", "install"}, Path: []string{"plugins", "marketplace"}},
