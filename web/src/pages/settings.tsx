...
export function SettingsPage() {
  ...
  function setExposureMode(mode: PublicConfig["server"]["expose"]["mode"]) {
    ...
    setConfig({ ...config, server: { ...config.server, expose: { mode, interfaces: mode === "interfaces" ? current : [] } }, auth: mode === "0.0.0.0" ? { ...config.auth, mcp_enabled: true, admin_enabled: true } : config.auth })
  }
