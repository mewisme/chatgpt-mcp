...
type ScrollAreaProps = React.ComponentProps<typeof ScrollAreaPrimitive.Root> & { scrollbars?: "vertical" | "horizontal" | "both" }

function ScrollArea({ className, children, scrollbars = "both", ...props }: ScrollAreaProps) {
  return (
