import { Activity, Home, Server, Settings, Wrench } from "lucide-react"
import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarMenu, SidebarMenuButton, SidebarMenuItem } from "@/components/ui/sidebar"

const items = [{ id: "overview", title: "Overview", icon: Home }, { id: "tools", title: "Tools", icon: Wrench }, { id: "servers", title: "MCP Servers", icon: Server }, { id: "activity", title: "Activity", icon: Activity }, { id: "settings", title: "Settings", icon: Settings }]
