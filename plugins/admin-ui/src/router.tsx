...
export const adminRoutes: RouteObject[] = [{
  ...
  children: [
    ...
    { path: "workspaces/global", element: <Navigate replace to="/instructions" /> },
    {
      ...
      children: [
        { index: true, lazy: () => import("@/pages/workspace-overview").then((module) => ({ Component: module.WorkspaceOverviewPage })) },
        { path: "context", lazy: () => import("@/pages/workspace-context-page").then((module) => ({ Component: module.WorkspaceContextPage })), handle: { title: "Project Context", description: "Preview the effective instruction context for this workspace." } satisfies AdminRouteHandle },
        { path: "requests", lazy: () => import("@/pages/workspace-requests").then((module) => ({ Component: module.WorkspaceRequestsPage })), handle: { title: "Workspace Requests", description: "Review control approval requests scoped to this workspace." } satisfies AdminRouteHandle },
        { path: "activity", lazy: () => import("@/pages/workspace-activity").then((module) => ({ Component: module.WorkspaceActivityPage })), handle: { title: "Workspace Activity", description: "Inspect activity and command executions scoped to this workspace." } satisfies AdminRouteHandle },
        { path: "activity/:executionID", lazy: () => import("@/pages/workspace-execution").then((module) => ({ Component: module.WorkspaceExecutionPage })), handle: { title: "Command Execution", description: "Inspect one run_command execution and its live output." } satisfies AdminRouteHandle },
        { path: "plugins", lazy: () => import("@/pages/workspace-plugins").then((module) => ({ Component: module.WorkspacePluginsPage })), handle: { title: "Workspace Plugins", description: "Configure plugins installed for this workspace." } satisfies AdminRouteHandle },
      ],
    },
