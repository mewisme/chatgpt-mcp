import { Activity, Cloud, FolderGit2, Home, Server, Settings, Wrench } from "lucide-react"
import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarMenu, SidebarMenuButton, SidebarMenuItem } from "@/components/ui/sidebar"

const items = [
  { id: "overview", title: "Overview", icon: Home },
  { id: "workspaces", title: "Workspaces", icon: FolderGit2 },
  { id: "tools", title: "Tools", icon: Wrench },
  { id: "servers", title: "MCP Servers", icon: Server },
  { id: "tunnel", title: "Tunnel", icon: Cloud },
