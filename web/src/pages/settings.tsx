...
export function SettingsPage() {
  ...
  async function save() {
    ...
    try {
      ...
      setMessage("Saved. Feature and auth changes apply immediately; restart the server for listener changes."); setError("")
