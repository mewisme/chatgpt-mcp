...
type DashboardData = { workspaces: number; tools: number; servers: number; enabledServers: number; tunnel: "Ready" | "Connecting" | "Stopped"; preset: string; mcpEndpoint: string; adminEndpoint: string; mcpAuth: boolean; adminAuth: boolean; updatedAt: Date }
