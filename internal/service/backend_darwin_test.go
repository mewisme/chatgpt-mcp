...
func TestDarwinSystemPlistRunsAsInvokingUser(t *testing.T) {
	spec := Spec{ID: "chatgpt-mcp-system-test", Scope: ScopeSystem, ConfigRoot: "/Users/mew/.config/chatgpt-mcp", Binary: "/Users/mew/.local/bin/cgm", Account: Account{Username: "mew", UID: "501", GID: "20", HomeDir: "/Users/mew"}}
...
func TestDarwinUserPlistDoesNotOverrideIdentity(t *testing.T) {
	spec := Spec{ID: "chatgpt-mcp-user-test", Scope: ScopeUser, ConfigRoot: "/Users/mew/.config/chatgpt-mcp", Binary: "/Users/mew/.local/bin/cgm", Account: Account{Username: "mew", UID: "501", HomeDir: "/Users/mew"}}
	plist := DarwinPlist(spec)
